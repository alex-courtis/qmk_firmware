...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_planck_1x2uC(
            ...
            KC_LCTL,      KC_DEL,       KC_LGUI,      KC_LALT,      LOWER,               KC_SPC,              RAISE,        KC_LEFT,      KC_DOWN,      KC_UP,        KC_RGHT
            ),
    ...
    [_ADJUST] = LAYOUT_planck_1x2uC(
            ...
            KC_NO,        KC_NO,        KC_NO,        KC_NO,        KC_TRNS,             KC_NO,               KC_TRNS,      KC_NO,        KC_NO,        KC_NO,        LED_LEVEL
            ),
};
