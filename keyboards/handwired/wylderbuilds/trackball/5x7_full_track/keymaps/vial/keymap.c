...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7(
        ...
        KC_BTN3,  KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G,   KC_HOME,    KC_MUTE,  KC_H, KC_J, KC_K,   KC_L,   KC_SCLN, KC_QUOT,   KC_BTN3,
    ...
    [_LOWER] = LAYOUT_5x7(
        ...
        _______,_______,KC_HOME,KC_PGUP,KC_PGDN,KC_END ,KC_LPRN,  KC_HOME,    KC_MUTE, KC_RPRN, KC_P4 , KC_P5 , KC_P6 ,KC_MINS,KC_PIPE,_______,
