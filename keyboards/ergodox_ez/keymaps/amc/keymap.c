...
KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, KC_NO, KC_LSFT, KC_LEFT, KC_RGHT, KC_NO, KC_NO, KC_UP, KC_DOWN, LSFT(KC_INS), KC_NO, KC_TAB, KC_LGUI, KC_RGUI, KC_DEL, KC_F2, KC_F3, KC_BSPC, KC_ESC, KC_F1, KC_F4, KC_ENT, KC_SPC)
};
